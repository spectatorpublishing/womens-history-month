...
const AandE = () => {
    return(
        <>
        <SectionTitle title="Arts & Entertainment"/>
        <Article1
        ...
        <Article1
            ...
            link2= '/news'
        />
        <NextSection nextseclink='/spectrum' nextsec='Spectrum' image="https://patch.com/img/cdn20/users/23306266/20200814/041504/styles/patch_image/public/columbia-university-building___14161440408.jpg"></NextSection>
        </>
    );
};

export default AandE;