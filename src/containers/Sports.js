...
const Sports = () => {
    return(
        ...
        <Article1
            ...
            link2= '/news'
        />
        <NextSection nextseclink='/credits' nextsec='Credits' image="https://patch.com/img/cdn20/users/23306266/20200814/041504/styles/patch_image/public/columbia-university-building___14161440408.jpg"></NextSection>
        </>
    );
};
